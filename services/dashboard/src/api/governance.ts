 ...
 *
 * The dashboard deliberately validates the complete GET/PUT success payload at
 * its orchestrator boundary. A malformed response must fail loudly instead of
