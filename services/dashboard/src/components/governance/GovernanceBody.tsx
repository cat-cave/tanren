...
function PostureForm(props: { projectId: string; governance: GovernanceView; csrfToken: string | undefined }) {
  ...
  return (
    <form class="posture-form" method="post" action="/settings/governance">
      ...
      <input type="hidden" name="revision" value={props.governance.revision} />
      <div class="form-grid">
        <div class="field">
            ...
            <section class="panel" data-governance-panel>
              ...
              <div class="panel-body">
                ...
                <div class="context-line">
                  ...
                  governancePosture={props.governance.governancePosture} · revision={props.governance.revision}
                </div>
                <PostureForm
