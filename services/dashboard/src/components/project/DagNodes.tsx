          ...
          <g>
            {h.attention !== null && (
              <g transform={`translate(${h.cx + 44}, 18)`} class="dag-ms-badge">
                <circle r="10" fill="var(--status-warn, oklch(70% 0.16 75))" stroke="var(--bg-canvas)" stroke-width="2" />
                <text x="0" y="3.5" fill="var(--accent-on)" font-family="var(--font-mono)" font-size="10" font-weight="700" text-anchor="middle">
                  {h.attention}
                </text>
              </g>
            )}
            <text x={h.cx} y={40} fill={color} font-family="var(--font-mono)" font-size="10" text-anchor="middle" letter-spacing="0.18em" font-weight="700">
              {truncate(h.label, 16)}
            </text>
          </g>
        );
...
export function DagNodeRect(props: { placed: PlacedNode }) {
  ...
  return (
    ...
    >
      {pulse !== undefined && (
        <rect class="dag-pulse" x="-2" y="-2" width={w + 4} height={h + 4} rx="3" fill="none" stroke={pulse} stroke-width="1.5" opacity="0.6">
