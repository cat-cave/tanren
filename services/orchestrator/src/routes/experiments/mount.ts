...
export function mountReportRoutes(app: Hono<ActorContextEnv>, deps: MountReportRoutesDeps): void {
  ...
  // mq-1 typed authority-signal projection: the per-evaluation evidence read for
  // the same merge-queue operator screen as integration metrics and queue stats.
