...
// The runtime Slack channel
// recognizes that explicit bot target and invokes `chat.postMessage`. An incoming
// webhook is not minted here: a webhook URL is itself a
