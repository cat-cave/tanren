...
// mq-15: the sealed merge-train watcher factory + its injected substrate types, re-exported
// off this same barrel so the autonomy-loops boot imports every post-merge watcher from ONE
// symbol source (the max-dependencies cap).
export { buildMergeTrainArtifactWatcher, type CasByteStore, type ProofSubstrate } from "./mergeTrainArtifactWatcher.js";
