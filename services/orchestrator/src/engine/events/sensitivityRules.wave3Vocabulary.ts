...
export const wave3VocabularySensitivityRules: SensitivityRule[] = [
  ...
  ...publicRules("symptom.contract.validated", ["projectId", "issueLoopId", "contractId", "canonicalHash", "validationTaskId"]),
  ...
  ...publicRules("merge.member.isolated", ["projectId", "partitionId", "groupId", "memberId", "reason", "findingIds", "findingIds[]"]),
