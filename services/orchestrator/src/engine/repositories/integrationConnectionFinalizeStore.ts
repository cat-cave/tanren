...
import {
  ...
  issueLinkReservation,
  type FinalizeVerifiedLinkInput,
  type FinalizeVerifiedLinkResult,
  type LinkReservation,
} from "./integrationConnectionFinalizeContracts.js";

// SQL reservation, Vault finalization, and activation handoff remain one durable
// state machine, separate from its branded reservation contract.
