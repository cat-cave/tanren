// Event-append capture for RoutesPool — keeps routesPool under the 500-line cap.
// Matches PgEventStore.append INSERT param order (run/task/spec/project/org/type/payload).
