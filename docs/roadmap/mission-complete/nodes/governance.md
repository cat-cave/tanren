...
| ------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **F1 governance tiers**         | No named tier, inheritance, immutable revision, effective-policy hash, rule coverage, CODEOWNER enforcement, protected deployment environment, freeze, or review quorum. A member can mutate `auditPosture` through generic project PATCH because it is omitted from the reserved governance fields ([projectConfigWriteGuards.ts](/home/trevor/projects/tanren/services/orchestrator/src/engine/workflow/projectConfigWriteGuards.ts:26), [projects route](/home/trevor/projects/tanren/services/orchestrator/src/routes/projects/index.ts:136)). **gv-2 implements the exact-head simulated-review publication preparation (node not merge-ready; completion/count dependency-gated and zero)**: strict simulated review posts real `APPROVE`/`REQUEST_CHANGES` on the exact head via a distinct reviewer identity, binds an all-or-nothing forge receipt onto terminal `review.*`, and land authorization compares the receipt `headSha` to the head being landed (event existence alone never authorizes a drifted head). Remaining F1 gaps: named tiers, immutable revisions, quorum, CODEOWNERS, freeze, protected deploy envs, visibility-as-predicate. Repo visibility is not persisted on `projects` ([schemaCore.ts](/home/trevor/projects/tanren/db/src/schemaCore.ts:30)). | Private-repo creation transport and strict simulated-review publication exist (gv-2). Live dual App+static forge APPROVE/REQUEST_CHANGES is still an operator/live-only proof gap. Named tiers / effective-policy hash / private-visibility enforcement remain open.                                                                                                                                    | Immutable tier revisions; private visibility as an enforced predicate; path/category quorums; `P3` zero-defect posture where required. (Strict forge publication + exact-head land bind: **implemented by gv-2's retained preparation; node completion/merge/count dependency-gated and zero — not shipped**.) |
...
The complete governance HTTP endpoint surface (policies/tiers, coverage/decisions,
reviews, audit lineage, integration/queue control, budgets, notifications, and
deployment environments/promotions) has been split into
[governance-http-surface.md](./governance-http-surface.md) to keep this file under
the 500-line architecture cap. Full content and heading meaning are preserved there.
