...
| Deploy target             | Provider org/team token                                                                         | Project/app/site, env vars, preview URL pattern, deployment hook             | **Shipped** for **Vercel + Fly** (`provisioners/{vercel,fly}DeployProvisioner.ts`): create app/project, attach env vars, store preview URL + deploy refs.               |
