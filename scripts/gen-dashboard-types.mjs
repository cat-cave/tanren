...
function renderFile() {
  ...
  const header = [
    ...
    "// Client response types generated from contracts/json/http/** (the orchestrator's Zod export).",
    "// Regenerate with `corepack pnpm run codegen:dashboard-types`;",
    "// `check:dashboard-types-drift` fails when this file diverges from the schemas.",
    "// See docs/architecture/future-refactor-and-scale.md §2.",
    "",
    "",
  ].join("\n");
