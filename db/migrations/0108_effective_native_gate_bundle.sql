...
-- The decisive V2 coordinate is the full proofReuseKey identity. These columns are
-- nullable for historical SP-3 bundles; V2 verification requires every value.
...
ALTER TABLE "gate_proof_bundles" ADD COLUMN "quarantine_version" text NOT NULL;--> statement-breakpoint
