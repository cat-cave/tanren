...
# bh-14b: org-scoped self-healing funnel read surface — a caller org sees only its
# own issue loops; a foreign org is denied; asserted as the restricted app role.
